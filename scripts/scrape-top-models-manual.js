...
/**
 * StockX Top Models (Most Active) ページのスクレイピング（手動検証対応版）
 */
class StockXTopModelsManualScraper {
  constructor() {
    this.browser = null;
    this.page = null;
  }
...
// メイン実行関数
async function main() {
  const scraper = new StockXTopModelsManualScraper();
...
module.exports = { StockXTopModelsManualScraper, main };
